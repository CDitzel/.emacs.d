...
(defun efs/exwm-init-hook ()
  ...
  (efs/run-in-background "timedatectl")
...
(defun efs/configure-window-by-class ()
  (interactive)
  (pcase exwm-class-name
    ("Gnome-terminal" (exwm-workspace-move-window 2))
    ("Firefox" (exwm-workspace-move-window 3))
    ("telegram-desktop" (exwm-workspace-move-window 4))
    ("vlc" (exwm-floating-toggle-floating)
...
(custom-set-variables
 '(exwm-manage-configurations
   '(((and
       ...
       (string-match-p "Google-chrome" exwm-class-name))
      floating-mode-line nil tiling-mode-line nil))))
  
(setq exwm-manage-configurations
   '((string= exwm-instance-name "google-chrome")
      workspace 3))
  ...
  (setq exwm-input-global-keys
        `(
          ...
          ([s-left] .desktop-environment-brightness-normal-increment "5%+")
...
;; char mode by default in certain buffers
